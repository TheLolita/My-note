...
2. 在启动类上加上@MapperScan("com.zs.mybatis42.mapper")指定要变成实现类的接口所在的包，然后包下面的所有接口在编译之后都会生成相应的接口实现类
...
[贫穷](https://blog.csdn.net/songpeiying/article/details/88065187)拯救者
