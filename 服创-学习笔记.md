...
● CentOS7结束[端口进程](https://blog.csdn.net/xcyww/article/details/89187698)

​	Windows结束进程：

​	1.netstat -aon | findstr '8081'

 2. taskkill /pid 7024 -f

    ![1584150812043](image/服创-学习笔记/1584150812043.png)
...
想从远端仓库更新代码到本地仓库,[参考](https://blog.csdn.net/nakiri_arisu/article/details/80259531)
...
while i<1001 do
insert into
users (`username`,`email`,`phone`,`password`)VALUES( CONCAT('尼尔_',CONVERT(i,CHAR)),CONCAT(CONVERT(199600000+i,CHAR),'m@qq.com'),CONVERT(13656000000+i,CHAR),'$2a$10$ySG2lkvjFHY5O0./CPIE1OI8VJsuKYEzOYzqIa7AJR6sEgSzUFOAm');
set i=i+1;
end while;
END
```
...
[Security身份认证之UserDetailsService](https://blog.csdn.net/qq_39329616/article/details/89978773)
